...
# {'douban_user_id': u'46626916',
# 'name': u'askender',
# 'access_token': u'7aff8c97b06dc7fd70fea5c7114957f7',
# 'session_expires': 604800, 'id': u'46626916',
# 'avatar': u'http://img3.douban.com/icon/u46626916-1.jpg'}
...
class DoubanMixin(OAuth2Mixin):
    ...
    def get_authenticated_user(
        self, redirect_uri, client_id, client_secret, code,
